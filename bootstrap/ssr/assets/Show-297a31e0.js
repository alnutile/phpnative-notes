...
import { _ as _sfc_main$3 } from "./Layout-85fa3394.js";
import { useForm } from "@inertiajs/vue3";
import { _ as _sfc_main$4 } from "./ActionMessage-8d62f3c2.js";
import { useToast } from "vue-toastification";
import { Combobox, ComboboxInput, ComboboxOptions, ComboboxOption } from "@headlessui/vue";
import _sfc_main$5 from "./ResourceNoEditor-dd0373fe.js";
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "border border-gray-400 px-40 py-10 rounded-md border-dashed shadow-lg flex flex-col justify-center text-center max-w-2xl" }, _attrs))}>`);
      if (!unref(form).processing) {
        _push(`<div${ssrRenderAttrs(unref(getRootProps)())}><input${ssrRenderAttrs(unref(getInputProps)())}>`);
        if (!unref(form).processing) {
          _push(`<p>Drop the files here ...</p>`);
        } else {
          _push(`<p>Drag &#39;n&#39; drop some files here, or click to select files</p>`);
        }
        _push(`<div class="mt-4"><button class="btn btn-default rounded-none">Upload</button></div></div>`);
      } else {
        _push(`<div class="flex justify-center items-center gap-4"> Uploading <span class="loading loading-bars loading-lg text-primary"></span></div>`);
      }
      _push(`</div>`);
    };
  }
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Components/Files.vue");
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            ssrRenderList(__props.note.data.files, (file) => {
              _push2(`<div${_scopeId}><div class="mb-2"${_scopeId}><a class="underline"${ssrRenderAttr("href", file.link)}${_scopeId}>Name: ${ssrInterpolate(file.name)}</a></div><img class="align-self-auto max-w-2xl max-h-full"${ssrRenderAttr("src", `data:image/jpeg;base64,${file.data}`)}${_scopeId}></div>`);
            });
            _push2(`<!--]--></div></div><dialog id="my_modal_1" class="${ssrRenderClass([{ "modal-open": showFileUpload.value }, "modal"])}"${_scopeId}><div class="modal-box"${_scopeId}><h3 class="font-bold text-lg"${_scopeId}>Upload files</h3><div class="modal-action"${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$1, {
              note: __props.note.data
            }, null, _parent2, _scopeId));
            _push2(`</div><div class="flex justify-end"${_scopeId}><button class="btn" type="button"${_scopeId}>Close</button></div></div></dialog>`);
          } else {
            return [
                    ...
                    return openBlock(), createBlock("div", {
                      ...
                      createVNode("div", { class: "mb-2" }, [
                        createVNode("a", {
                          class: "underline",
                          href: file.link
                        }, "Name: " + toDisplayString(file.name), 9, ["href"])
                      ]),
                      createVNode("img", {
              ...
              createVNode("dialog", {
                id: "my_modal_1",
                class: ["modal", { "modal-open": showFileUpload.value }]
              }, [
                createVNode("div", { class: "modal-box" }, [
                  createVNode("h3", { class: "font-bold text-lg" }, "Upload files"),
                  ...
                  createVNode("div", { class: "flex justify-end" }, [
                    createVNode("button", {
                      class: "btn",
                      type: "button",
                      onClick: ($event) => showFileUpload.value = false
                    }, "Close", 8, ["onClick"])
                  ])
                ])
              ], 2)
