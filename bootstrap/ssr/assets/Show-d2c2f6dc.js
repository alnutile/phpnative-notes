    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div${_scopeId}><h2 class="text-white text-2xl"${_scopeId}>Settings</h2><div class="max-w-full mx-auto dark:text-gray-300 mt-10"${_scopeId}><div${_scopeId}>Storage Page: ${ssrInterpolate(__props.storage_path)}</div><div${_scopeId}><h2${_scopeId}>Backup</h2>`);
            ...
            return [
              createVNode("div", null, [
                ...
                createVNode("div", { class: "max-w-full mx-auto dark:text-gray-300 mt-10" }, [
                  createVNode("div", null, "Storage Page: " + toDisplayString(__props.storage_path), 1),
                  createVNode("div", null, [
